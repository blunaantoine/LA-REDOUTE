...
import { Car, CircleDot, Droplets, Wrench, Search, ArrowLeft, ChevronRight, Star, Sparkles } from 'lucide-react'
...
export default function AutomobilePage({ content, products }: AutomobilePageProps) {
  ...
  const featuredProduct = autoProducts.find(p => p.imageUrl) || autoProducts[0] || null
                  ...
                  <div className="relative h-48 md:h-56 overflow-hidden">
                    {featuredProduct.imageUrl ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-[#00A651]/10">
                        <Car className="size-12 text-[#00A651]" />
                      </div>
                    )}
      ...
      <section className="py-8 bg-white border-b border-gray-100 sticky top-16 sm:top-20 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            {/* Subcategory Filters with animated indicator */}
